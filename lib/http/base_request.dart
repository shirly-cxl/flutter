...
import 'package:total/http/api.dart';
import 'package:total/http/progress_dialog.dart';
import 'package:total/common/hud_view.dart';
...
//     ls.onStart();
    ...
    if (context != null && hud != null) HudView.show(context, msg: hud);
    var result =
        await api(this.url(), reqType, this.retJson(), this, this.cacheTime());
