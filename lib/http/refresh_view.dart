...
import 'package:total/common/ui.dart';
...
class ClassicalFooterWidgetState extends State<ClassicalFooterWidget>
  ...
  String get _loadText {
    return widget.classicalFooter.loadText ?? 'pushToLoad';
  }

  String get _loadReadyText {
    return widget.classicalFooter.loadReadyText ?? 'releaseToLoad';
  }
  ...
  String get _loadFailedText {
    return widget.classicalFooter.loadFailedText ?? 'loadFailed';
  }

  /// 没有更多文字
  String get _noMoreText {
    return widget.classicalFooter.noMoreText ?? 'noMore';
  }

  String get _infoText {
    return widget.classicalFooter.infoText ?? 'updateAt';
  }
  ...
  List<Widget> _buildContent(bool isVertical, bool isReverse) {
    return isVertical
        ? <Widget>[
            new Icon(Icons.all_inclusive, color: themeColor),
            new Space(),
            new Text(
              '松开加载',
